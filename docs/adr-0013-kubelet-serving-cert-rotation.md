...
- `docs/adr-0004-substrate-only-base.md` — substrate-only thesis; the `infrastructure/`
  count invariant + disposition table were amended here for the cert-approver relocation.
- `docs/adr-0002-namespace-ownership-rendered-manifests.md` — namespace sole-owner model.
