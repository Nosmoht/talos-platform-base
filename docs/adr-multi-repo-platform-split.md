...
of a second cluster (`office-lab`, corporate site, internal-only,
3 control-plane and 4 worker nodes, no GPU, no WAN edge), the single-overlay /
single-repo model becomes insufficient:
