...
- [ADR: Verify public Day-0 chart downloads before local rendering](0027-verified-public-seed-charts.md) - keeps ArgoCD and Cilium chart archives publicly hosted while verifying base-owned SHA-256 digests before their local Day-0 renders; partially supersedes ADR-0007's deferred chart-integrity path (accepted)
